...
using a microcontroller and a programming language. A comparison study is also given to show the utility of the application, then numerous  evaluations were done to validate our apporoach.
Finaly a real implementation of the application is realised.
