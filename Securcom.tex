...
\title{Using the EMG signal to Control Multimedia Player}

\author{\IEEEauthorblockN{Mohamed Tahar HAMMI, Zahra MAATOU, Salem OSMAN and Ahmed MEHAOUA}
...
\begin{abstract}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Sinsce computer invention, Human-Computer Interactions are gaining evolution. 
At the beggining, control was limited to CLI (Command Line Interface) use. After, Microsoft invented the first graphical HCI. Nowadays, touch screens are gaining ground for control operations.
However, people with reduced mobility or that have special needs cannot use these HMI, for this reason "Vision-based", "Movement-based", and "EMG-based" HMI exists.
