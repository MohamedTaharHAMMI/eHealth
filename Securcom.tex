...
biomedical, gaming, 3D animations, and human-machine interfaces.
EMG signal require advanced methods for detection, decomposition, processing, and classi
fication. The purpose of this paper is to realise a novel human-machine interface EMG-based to control a multimedia
applications. Numerous  evaluations were done. powerful, flexible, and efficient application Then, using a microcontroller and a programmation langage, we implemented a real application.
These different evaluations proved the effictiveness of our apporoach. A
...
people with reduced mobility or that have special needs cannot use "Vision-based", "Movement-based", and "EMG-based" HMI exists.
