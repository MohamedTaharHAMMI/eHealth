...
In order to validate our proposal, firstly, numerous  evaluations were done. Then, using a microcontroller and a programmation langage, we implemented a real application.
