...
a multimedia, using a microcontroller. A comparison study is also given to show the utility of the application, 
then numerous evaluations were provided to validate our apporoach. Finaly a real implementation of the application
is realised.
...
\par TThe power distribution of the EMG signal can be calculated by the “Fast Fourier Transformation” (FFT) and graphically presented as a total power
